 ...
 * </pre>
 */
public class SkepticBreaker implements MonitoredService, ServiceWrapper {
    /**
    ...
    protected AtomicLong waitTime = new AtomicLong(15 * 1000L);
    ...
    //only getters for wait times themselves
